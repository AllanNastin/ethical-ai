...
master_dict = {"ORG": 
            ...
            "ALG": {"biometric identification", "biometric verification", "profiling", "artificial intelligence algorithms", "system behaviour", "democratic processes", "civic discourse", "electoral processes"},
